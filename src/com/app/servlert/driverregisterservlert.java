...
/**
 * Servlet implementation class driverregisterservlert
 */
public class driverregisterservlert extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public driverregisterservlert() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("driverregisterservlert POST");
		...
		if(request.getParameter("secret")==null){
			...
			String licensenum=request.getParameter("Driver[licenesenum]").toString();
			
			String platenum=request.getParameter("Driver[platenum]").toString();
			platenum=new String(platenum.getBytes("ISO-8859-1"),"UTF-8");
			int userid=Integer.parseInt(request.getParameter("Driver[userid]").toString());
			String imgpath=request.getParameter("Driver[carphotostream]").toString();
			
			
			String uppath="d://upload/"+imgpath.substring(imgpath.lastIndexOf("/"));
			    String sql="insert into drivertb values(null," +userid+
				",'"+licensenum+
				"','"+platenum+
